...
GitHub is a **website** that hosts Git repositories, and adds collaboration features on top: Issues, Pull Requests, code review, CI, and a social layer (stars, followers, profiles).
