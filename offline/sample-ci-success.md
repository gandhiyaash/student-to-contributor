...
This continues [`sample-ci-failure.md`](sample-ci-failure.md) — after the duplicate row is fixed and pushed.
...
Checking for duplicate GitHub usernames... OK
All 1 contributor row(s) valid.
